...
/* ./.libs/lt-ewfexport.c - temporary wrapper executable for .libs/ewfexport
   Generated by libtool (GNU libtool) 2.4.6

   The ewfexport program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ewfexport"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ewfexport - temporary wrapper script for .libs/ewfexport\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The ewfexport program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"ewfexport:ewfexport:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ewfexport:ewfexport:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ewfexport:ewfexport:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
