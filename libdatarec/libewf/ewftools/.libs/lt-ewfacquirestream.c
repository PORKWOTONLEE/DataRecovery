...
/* ./.libs/lt-ewfacquirestream.c - temporary wrapper executable for .libs/ewfacquirestream
   Generated by libtool (GNU libtool) 2.4.6

   The ewfacquirestream program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/home/67566/libewf-20140813/libewf/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/67566/libewf-20140813/libewf/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "ewfacquirestream"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ewfacquirestream - temporary wrapper script for .libs/ewfacquirestream\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The ewfacquirestream program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("  notinst_deplibs=' ../libewf/libewf.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"ewfacquirestream:ewfacquirestream:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ewfacquirestream:ewfacquirestream:$LINENO: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ewfacquirestream:ewfacquirestream:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='ewfacquirestream'\n", f);
  ...
  fputs ("    PATH=/home/67566/libewf-20140813/libewf/.libs:/usr/local/lib:/usr/local/bin", f);
  fputs (":$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/67566/libewf-20140813/libewf/.libs:$PATH\"\n", f);
  fputs ("\n", f);
